            ...
            <main className="max-w-7xl mx-auto px-6 py-12">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4 border-b border-gray-800 pb-6">
                    <div>
                        ...
                        <p className="text-gray-400">{series.length} titles saved</p>
                    </div>
                ...
                {series.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-20 border border-dashed border-gray-800 rounded-2xl bg-[#111]">
                        ...
                        <h3 className="text-xl font-bold text-gray-300 mb-2">No series yet</h3>
                        <p className="text-gray-500 mb-6">Start adding TV shows to track them here.</p>
                        <Link href="/series" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full font-bold transition-colors shadow-lg shadow-blue-900/20">
                            Browse Series
                        </Link>
                    </div>
                ) : (
